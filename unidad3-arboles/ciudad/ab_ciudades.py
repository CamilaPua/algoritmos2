#Clase Arbol
class ArbolBinario:
    def __init__(self, ciudad, arbol_izquierdo=None, arbol_derecho=None) -> None:
        self.ciudad = ciudad
    ...
    def __repr__(self) -> str:
        return str(self.ciudad.nombre)
    
    def __eq__(self, otro: object) -> bool:
        if not isinstance(otro, ArbolBinario):
            return False
        return self.ciudad == otro.ciudad
    ...
    def __verArbol(self, arbol:"ArbolBinario", recorrido:str, nivel=0) -> str:
        ...
        if arbol is None:
            return ""
        recorrido =  espaciado + str(arbol.ciudad) + "\n" \
    ...
    def descendencia(self) -> list:
        descendencia = self.preOrden()
        descendencia.pop(0)
        return descendencia
